...
public abstract class AssemblyCopierSupport extends BaseCompositeTransformer {
	...
	/**
	 * {@inheritDoc}
	 * @see net.sf.morph2.transform.transformers.BaseCompositeTransformer#getComponentType()
	 */
	...
	/**
	 * {@inheritDoc}
	 * @see net.sf.morph2.transform.transformers.BaseCompositeTransformer#setComponents(java.lang.Object[])
	 */
	...
	/**
	 * {@inheritDoc}
	 * @see net.sf.morph2.transform.transformers.BaseCompositeTransformer#setComponentValidator(net.sf.composite.validate.ComponentValidator)
	 */
